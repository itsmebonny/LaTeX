...
\begin{itemize}
  \item La funzione di Green per il semispazio superiore in \(\mathbb{R}^3\). Definito \(\mathbb{R}^3_+\) il semispazio
  \[
    \mathbb{R}^3_+ = \{(x_1, x_2, x_3): x_3 > 0\}
  \] 
  Sia \(\bm{x} = (x_1, x_2, x_3)\) e \(\bm{x}^+ = (x_1, x_2 -x_3)\) su \(y_3 = 0\)  
\end{itemize}
\end{document}