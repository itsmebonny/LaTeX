...
U(\xi) = c_0e^{-\frac{\xi^2}{4}} \qquad (c_0 \in \mathbb{R})  
\]
Usando la conservazione della massa ricaviamo, dividendo per \(Q\):
\begin{align}
  1 = \frac{1}{(Dt)^{\frac{n}{2}}} \int_{\mathbb{R}^n} U \left(\frac{|\mathbf{x}|}{\sqrt{Dt}}\right)d\mathbf{x} = \frac{c_0}{(Dt)^\frac{n}{2}}
\end{align}
\end{document}