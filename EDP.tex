...
\[
  ...
  \end{cases}
\]
con \(u^+, u^-\) costanti e diversi tra loro. La funzione \(q\) può essere sia convessa che concava. Tale problema è noto come \emph{problema di Riemann} e ha una importanza particolare nei casi di approssimazione numerica.
\begin{theorem}
...
\end{theorem}
\begin{proof}
  Nel primo caso \(u\) è ovviamente una soluzione integrale e poiché 
\end{proof}
\end{document}