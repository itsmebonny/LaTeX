...
\end{align}
Poichè la formula del binomio è
\[
...
Poichè la particella si muove indipendentemente dal passo precedente, se essa si trova in \(x\) al tempo \(t+\tau\), allora al tempo \(t\) si trovava: o in \(x-h\), o in \(x+h\), da cui si ricava
\begin{equation}
\begin{cases}
