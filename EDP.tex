...
\end{equation}
La (2.67) rappresenta la convoluzione del dato iniziale con la Gaussiana per ogni \(t>0\). Sia, per semplicità, \(D=\frac{1}{2}\) e \(B^x(t)\) la posizione di una particella Browniana partita dal punto \(x\), con \(g(y)\)
\end{document}