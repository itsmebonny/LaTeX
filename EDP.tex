...
\subsection{Problemi in dimensioni $\mathbf{n>1}$}
...
\end{equation}
Le equazioni (2.37) e (2.38) assieme a \(\int_{\mathbb{R}}\Gamma_D(x,t)dx = 1 \, \forall t >0\) implicano che per $t$ che tende a \(0\), la soluzione fondamentale tende a concentrarsi attorno all'origine. 
\end{definition}
\end{document}
