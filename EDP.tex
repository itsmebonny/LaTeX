...
\end{theorem}
Se una funzione possiede proprietà di media in un dominio \(\Omega\), non può assumere massimi (o minimi) in punti interni al dominio, eccetto nel caso in cui sia costante. Se \(\Omega\) è limitato. Nel caso di \(\Omega\) limitato e \(u\) non costante e continua in \(\overlline{\Omega}\), allora \(u\) assume il suo massimo (o minimo) esclusivamente su \(\partial \Omega\).
