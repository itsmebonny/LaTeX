...
\begin{equation}
  ...
  \end{cases}
\end{equation}
Sia \(u\) una soluzione regolare, almeno di classe \(\mathcal{C}^1\) in \(\mathbb{R} \times [0, +\infty)\). Si può dire che \(u\) sia una soluzione classica. Scelta ora una funzione \(v \in \mathcal{C}^1(\mathbb{R} \times [0, +\infty))\)
\end{document}