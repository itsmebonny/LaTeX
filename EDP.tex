...
\end{definition}
Poiché la soluzione integrale deve essere solo limitata, può ammettere discontinuità. La definizione (4.1) esprime in modo abbastanza soddisfacente tale soluzione. In alcuni casi tuttavia
\end{document}