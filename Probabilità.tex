...
\end{definition}
\begin{definition}
Lo spazio campionario $\Omega$ rappresenta l'insieme degli esiti elementari possibili $\omega$ di un esperimento aleatorio. Non è definito univocamente dall'esperimento.
\end{definition}
\begin{definition}
...
\begin{definition}
  ...
  I boreliani sono gli elementi di tale \(\sigma\)-algebra 
\end{definition}
\end{document}
