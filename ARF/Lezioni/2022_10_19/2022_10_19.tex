...
\begin{remark}
    ...
    This is not a big problem if \(f = g\) a.e. on \([a,b] \Longrightarrow f = g \in [a,b]\backslash N\) where \(\lambda(N) = 0\); \(x\) is a Lebesgue point for \(f\), \(\forall \; x \in \left[a, b\right] \backslash M, \ \lambda(M)=0\) \\
    \(\Rightarrow x \) is a Lebesgue point for \(g\), \(\ \forall x \in \left[a, b\right] \backslash (M \cup N)\) \\
    \(\left[a, b\right] \backslash (M \cup N)\) is a set of full measure of Lebesgue points for \(f\) and \(g\).
\end{remark}
