...
\begin{proof}
    ...
    Part 2. Note that \(\{x \in X: \text{ assumpions i) and ii) of the theorem do not hold}\}\) is a set of zero measure. Take \(F. \ X = E \cup F \) since we have the assumpion on \(E\) and \(\mu (F)=0\)
