...
\begin{definition}
    ...
    \begin{enumerate}
        \item \(X \in \mathcal{M}\)
        \item \(E \in \mathcal{M} \Longrightarrow E^C = X\setminus E \in \mathcal{M}\)
...
\begin{enumerate}
    ...
    \end{enumerate}
\begin{itemize}
    \item \(E, F \in \mathcal{M} \Longrightarrow E \setminus F \in \mathcal{M} = E \setminus F = E \cap F^C \in \mathcal{M}\)
