...
\end{insideleft}
\begin{insideright}
    Da: Bonni, Chela, Ila, David, Luci, Chia, Davide, Simo, Nico, Lollo, Fra, India, Manu
\end{insideright}
\begin{frontcover}
    Apprezza il nostro impegno
    \begin{tikzpicture}
        ...
        \begin{scope}[xshift=\i * .6cm,yshift = \yshift+1cm]
        \fill[purple!30] (1.5,3) arc[x radius=5pt, y radius=2.5pt, start angle=-180, end angle=0] -- ++(0,2) arc[x radius=5pt, y radius=2.5pt, start angle=0, end angle=-180] -- cycle;
        ...
        \foreach \i in {0,...,5} {
        \pgfmathsetmacro{\yshift}{-\i * (5 - \i) * .07cm}
        \begin{scope}[xshift=\i * .5cm,yshift = \yshift-0.8cm]
        ...
        \fill[pink] (1.5,5) arc[x radius=5pt, y radius=2.5pt, start angle=-180, end angle=180];
        \fill[yellow] (1.5,6.5) ++(5pt,0) .. controls +(0,-1) and +(.5,0) .. ++(0,-2.5) .. controls +(-.5,0) and +(0,-1) .. ++(0,2.5);
        \end{scope}
        }
...
\begin{backcover}
    ...
    \begin{tikzpicture}
        ...
        \foreach \i in {0,...,5} {
        \pgfmathsetmacro{\yshift}{-\i * (5 - \i) * .07cm}
        \begin{scope}[xshift=\i * .5cm,yshift = \yshift+1cm]
        \fill[purple!30] (1.5,3) arc[x radius=5pt, y radius=2.5pt, start angle=-180, end angle=0] -- ++(0,2) arc[x radius=5pt, y radius=2.5pt, start angle=0, end angle=-180] -- cycle;
        \fill[pink] (1.5,5) arc[x radius=5pt, y radius=2.5pt, start angle=-180, end angle=180];
        \fill[yellow] (1.5,7.5) ++(5pt,0) .. controls +(0,-1) and +(.5,0) .. ++(0,-2.5) .. controls +(-.5,0) and +(0,-1) .. ++(0,2.5);
        \end{scope}
