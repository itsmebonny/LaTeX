...
\tcolorboxenvironment{remark}{
  breakable,
    ...
    borderline west={1mm}{0pt}{green!35}
}
...
\newcommand{\jump}[1]{\left[\mspace{-4mu}\left[#1\right]\mspace{-4mu}\right]}
\newcommand{\average}[1]{\left\{\mspace{-7.5mu}\left\{#1\right\}\mspace{-7.5mu}\right\}}
...
\newmdenv[backgroundcolor=green!20]{background}
...
\input{sections/7_hyperbolic.tex}
\input{sections/8_DD.tex}
\end{document}
