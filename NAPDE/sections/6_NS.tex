...
\begin{equation}
    \txt{find }(\uvec_h, p_h) \in V_h\times Q_h :
    \begin{cases}
...
Formulation \eqref{22_slide_ns} is general enough to include formulation \eqref{15_slide_ns} of the Stokes problem. 