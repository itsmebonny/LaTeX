...
\begin{remark}[Remark, relation with weak convergence] If it is assumed that $\psi$ is independent of $y$, and ignoring the dependence on time (since the homogenization is performed on the spatial grid) it will be obtained:
$$ 
