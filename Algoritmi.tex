...
\begin{itemize}
    \item x\(0\): la costante nulla
    \item x\(1\): indirizzo di return
    \item x\(2\): puntatore dello stack
    \item x\(3\): puntatore globale
    \item x\(4\): puntatore del thread
    \item x\(5 - \mbox{x}7\), x\(28 - \mbox{x}31\): temporanee
    \item x\(8\): puntatore del frame
    \item x\(9\), x\(18- \mbox{x}27\): salvataggio variabili
    \item x\(10 - \mbox{x}11\): argomento funzioni/risultato
    \item x\(12 - \mbox{x}17\): argomento funzioni
\end{itemize}
