...
Con il comando \code{AND} si prendono due stringhe di bit, vengono confrontate e viene restituita una stringa di bit i cui bit hanno valore 1 se entrambi i bit degli argomenti avevano
\end{document}