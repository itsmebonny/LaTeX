...
\begin{center}
    ...
    \end{tabular}
\end{center}
Tuttavia se tutti gli indirizzi del programma dovessero stare all'interno della costante si avrebbero al massimo \(2^{20}\) possibili indirizzi, che non sono tantissimi. La soluzione arriva dal dividere il \textit{Program Counter} (\textit{PC}) in due parti
\[
...
\begin{enumerate}
    ...
    \item Register addressing: in questo caso il 
\end{enumerate}
\end{document}